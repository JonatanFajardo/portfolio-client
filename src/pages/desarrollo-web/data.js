...
const desarrolloweb = [
  {
    ...
    deweb_Descripcion:"Gestion colegial es un proyecto que permite agregar la información necesaria para la administación de un centro escolar. esta se encuentra desarrollada en Net. Core",
...
},
{
    ...
    deweb_Descripcion:"La version escritorio de Gestion colegial es un proyecto que permite agregar la información necesaria para la administación de un proyecto. Esta se encuentra desarrollada en Net. Framework",
...
},
{
    ...
    deweb_Descripcion:"Aplicacion la cual puede permitir el acceso a la base de datos de gestión colegial.",
...
},
{
    ...
    deweb_Descripcion:"PetsHome brinda ayuda para registrar la información la cual una organización de refugio de perros conlleva la cual esta desarrollado en Net. Core",
...
},
{
  ...
  deweb_Descripcion:"Desarrollo de paguina ilustrativa de un restaurante de comida asiatica.",
