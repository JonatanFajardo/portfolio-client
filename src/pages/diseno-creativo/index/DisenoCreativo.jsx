          ...
          <div class="row mc">
            ...
            <div class="col-sm-12 col-md-6  ">
              <div class="container">
                <h3>Sobre esto</h3>
                <p>
                  Ilustrador gráfico entusiasta por la creación y visualización
                  de imágenes digitales en las cuales me desenvuelvo de manera
                  creativa, auténtica y flexible, con la capacidad de comunicar
                  mensajes visuales a través de mis diseños con el objetivo de
                  consolidar las relaciones entre marca y cliente. Con un
                  enfoque en el desarrollo de interfaces de usuario para
                  entornos web, de aplicación, social media e ilustración
                  conceptual.
                </p>
              </div>
            </div>
