          ...
          <div class="col-lg-8">
            <div class="section-title text-center">
              ...
              <p class="text-muted mb-5">
                Dale clic al servicio que te interese desarrollar
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            ...
            >
              <div class="service-item shadow-sm p-4 rounded bg-white">
                ...
                <h3 class="fs-5 py-2">Desarrollo Web</h3>
                <p class="text-muted">
                  Realiza tu página web o aplicación desktop.
                </p>
              </div>
            </Link>
          </div>
          <div class="col-md-6 col-lg-6 mb-4">
            ...
            >
              <div class="service-item shadow-sm p-4 rounded bg-white">
                ...
                <h3 class="fs-5 py-2">Diseño Creativo</h3>
                <p class="text-muted">
                  Crea tu logo profesional o tu anuncio publicitario.
                </p>
              </div>
            </Link>
          </div>
